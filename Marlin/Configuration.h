...
#define STRING_CONFIG_H_AUTHOR "(RYTECH, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ryan's Dope 3D Printer"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.17, -4.64, -4.40 }
